      ...
      <div className='max-w-screen-xl  px-6 sm:px-8 lg:px-16 mx-auto flex flex-col w-full text-center justify-center'>
        <div className='flex flex-col w-full'>
          ...
          <div className='flex flex-col md:flex-row h-screen items-center'>
            <div className='bg-white w-full md:max-w-md lg:max-w-full md:mx-auto h-screen flex items-center justify-center'>
            ...
            <div className='block w-full h-screen'>
              <div className='w-full h-100'>
                <p className='text-xl md:text-3xl font-bold leading-tight mt-12'>
